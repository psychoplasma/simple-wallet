export const SPIN_CROWDSALE_CONTRACT_INTERFACE = [
...
export const SPIN_TOKEN_CONTRACT_INTERFACE = [
...
export const SPIN_TOKEN_CONTRACT_NAME = 'SpinToken';
export const SPIN_CROWDSALE_CONTRACT_NAME = 'SpinCrowdSale';