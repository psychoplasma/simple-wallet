...
class TokenUnlockableListCheck extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      address: '',
...
TokenUnlockableListCheck.propTypes = {
  onSubmit: PropTypes.func.isRequired
}

export default PopupPatcher(TokenUnlockableListCheck);
